...
public:
    ...
    //Function prototype to add value at thre start of the linked list.
    void addHead(int value)
    {
        //The logic autimatically implements this boundry check so there is no need to implement this code
        // if (head == NULL)
        // {
...
int main()
{
    ...
    //Adding 2 before the head
    c.addHead(2);
    //Adding 5 before the head
    c.addHead(5);
